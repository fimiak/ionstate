    ...
    return (
      <div>
        <div className="inner-home">
          <h3>Welcome to Retrk</h3>
          <p>Retrk is a daily tracking service of a selection of world leaders & their activities on a daily basis. Information is gathered from public releases, news articles, and social media.</p>
          <ul>
